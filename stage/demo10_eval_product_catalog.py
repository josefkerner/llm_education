...
from stage.demo9_product_catalog import ProductCatalogChatbot
class ChatbotEvaluator:
    def __init__(self):
        self.chatbot = ProductCatalogChatbot()
        self.qa_pairs = self.load_question_answer_pairs(file_path='data/product_qa_pairs.jsonl')
